...
ggsave("Spp Figure 3 PD vs MPD change map rcp60 low disp.tiff",FinalComb,width=18, height=8, unit="in", dpi=600, bg="transparent")
ggsave("Spp Figure 3 PD vs MPD change map rcp60 low disp.png",Final,width=24, height=13, unit="in", dpi=600, bg="transparent")
