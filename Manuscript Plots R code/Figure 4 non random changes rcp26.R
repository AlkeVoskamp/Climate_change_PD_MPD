...
CombCon <- read.csv("PDandMPD_random_changes_medium_dispersal_rcp26_2080.csv")
...
ggsave("Spp Figure 4 Random_PD and_MPD_change_rcp26_significant_cells.tiff",CombNull,width=35, height=13, unit="in", dpi=300, bg="transparent")
